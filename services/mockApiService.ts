...
export const MOCK_USERS: User[] = [
  { id: '1', name: 'Alice Admin', email: 'a.admin@adityabirla.com', mobile: '9876543210', role: UserRole.ADMIN, access: AccessLevel.READ_WRITE, avatar: 'https://i.pravatar.cc/150?u=1' },
  { id: '2', name: 'Bob Manager', email: 'b.manager@adityabirla.com', mobile: '9876543211', role: UserRole.MANAGER, access: AccessLevel.READ_WRITE, avatar: 'https://i.pravatar.cc/150?u=2' },
  { id: '3', name: 'Charlie Architect', email: 'c.archi@adityabirla.com', mobile: '9876543212', role: UserRole.ARCHITECT, access: AccessLevel.READ_WRITE, avatar: 'https://i.pravatar.cc/150?u=3' },
  { id: '4', name: 'Diana Builder', email: 'd.builder@adityabirla.com', mobile: '9876543213', role: UserRole.MEMBER, access: AccessLevel.READ_WRITE, avatar: 'https://i.pravatar.cc/150?u=4' },
  { id: '5', name: 'Victor Vendor', email: 'v.vendor@adityabirla.com', mobile: '9876543214', role: UserRole.VENDOR, access: AccessLevel.READ_ONLY, avatar: 'https://i.pravatar.cc/150?u=5' },
  { id: '6', name: 'Susan Supplier', email: 's.supplier@adityabirla.com', mobile: '9876543215', role: UserRole.VENDOR, access: AccessLevel.READ_ONLY, avatar: 'https://i.pravatar.cc/150?u=6' },
  { id: '7', name: 'Mike Manager', email: 'm.areamanager@adityabirla.com', mobile: '9876543216', role: UserRole.AREA_MANAGER, access: AccessLevel.READ_WRITE, avatar: 'https://i.pravatar.cc/150?u=7' },
